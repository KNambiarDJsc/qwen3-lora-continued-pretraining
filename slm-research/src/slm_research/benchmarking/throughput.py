...
def measure_throughput(model: Any, benchmark_config: dict[str, Any]) -> dict[str, float]:
    """Run the throughput measurement pass per configs/benchmarking/default.yaml.

    Raises:
        NotImplementedError: implementation lands in Phase 8 (Benchmarking).
    """
    raise NotImplementedError("Phase 8: implement throughput measurement.")
